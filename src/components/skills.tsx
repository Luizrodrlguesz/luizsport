...
import nextLogo from "/src/assets/skills/next.png";
import antLogo from "/src/assets/skills/ant-design.png";
import postmanLogo from "/src/assets/skills/postman.png";
...
const allSkills: SkillsData = {
  front: [
    ...
    },
    {
      ...
      logo: antLogo,
      description: {
        pt: "Biblioteca de componentes React com design elegante e pronto para uso corporativo, facilitando o desenvolvimento de interfaces modernas.",
        en: "React component library with elegant design and enterprise-ready features, making it easier to build modern UIs.",
        fr: "Bibliothèque de composants React avec un design élégant et des fonctionnalités prêtes pour l'entreprise, facilitant la création d'interfaces modernes.",
      },
    },
  ],
  back: [
    ...
    },
    {
      ...
      logo: nextLogo,
      description: {
        pt: "Framework React que oferece renderização server-side, geração de sites estáticos e excelente performance para aplicações web modernas.",
        en: "React framework that provides server-side rendering, static site generation, and great performance for modern web applications.",
  ...
  outros: [
    ...
    },
    {
      ...
      logo: postmanLogo,
      description: {
        pt: "Plataforma para testar, documentar e automatizar APIs, essencial para validar endpoints e simular requisições HTTP durante o desenvolvimento.",
        en: "Platform to test, document, and automate APIs—essential for validating endpoints and simulating HTTP requests during development.",
        fr: "Plateforme pour tester, documenter et automatiser des API, essentielle pour valider les endpoints et simuler des requêtes HTTP pendant le développement.",
      },
    },
    {
      id: "vercel",
...
export default function SkillsSection() {
  ...
  return (
    <section className="section skills" ref={sectionRef}>
      ...
      />
      <h2
        className={`text-center text-2xl font-bold mb-6 section-title-animate${
      ...
      <div
        className={`skills-wrapper animated-section ${
          animatingCategory ? "fade-slide-out" : "fade-slide-in"
        }`}
      >
        <div
          className={`skill-preview animated-preview ${
            animatingSkill ? "fade-zoom-out" : "fade-zoom-in"
          }`}
        >
          <img
          ...
          <p className="preview-description">
            {selectedSkill?.description[language]}
          </p>
        </div>
